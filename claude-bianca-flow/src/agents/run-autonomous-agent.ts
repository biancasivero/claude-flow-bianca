...
Adicione as seguintes ferramentas GitHub ao arquivo /Users/agents/Desktop/claude-bianca-flow/mcp-bianca-tools/src/tools/github/index.ts:
...
`;
  ...
  try {
    ...
    await runAutonomousImprovement(
      improvementTask,
      '/Users/agents/Desktop/claude-bianca-flow/mcp-bianca-tools'
    );
